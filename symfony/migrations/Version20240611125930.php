 ...
 */
final class Version20240611125930 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contact (id INT AUTO_INCREMENT NOT NULL, salutation VARCHAR(10) NOT NULL, first_name VARCHAR(30) NOT NULL, last_name VARCHAR(30) NOT NULL, street VARCHAR(30) NOT NULL, house_number VARCHAR(5) NOT NULL, city VARCHAR(30) NOT NULL, postal_code VARCHAR(10) NOT NULL, email VARCHAR(30) NOT NULL, company_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
